window.SIDECAR_SITE_CONTENT = {
  ...
  whoWeServe: {
    ...
    intro:
      "We go deep before we go wide. In our first year we focus exclusively on professional service firms — because that is where AI delivers the fastest, most visible results.",
    cards: [
      {
        title: "Insurance Agencies",
        body:
          "AI for quote follow-up, renewal automation, client communication, and CRM integration. Get back hours every week on admin that AI can handle.",
      },
      {
        title: "Law Firms",
        body:
          "AI for client intake, document summarization, email drafting, deadline reminders, and billing narrative generation.",
      },
      {
        title: "Real Estate Offices",
        body:
          "AI for lead nurture sequences, listing descriptions, market report summaries, and automated client follow-up.",
      },
      {
        title: "Accounting Firms",
        body:
          "AI for document sorting, client communication templates, deadline tracking, and data entry automation.",
      },
    ],
    note: {
